    ...
    return (
        <div className={`h-screen max-w-full relative ${styles.flexCenter} flex-col overflow-hidden bg-creamWhite`}>
            ...
            <div className={`text-white z-50 md:mt-10 hidden md:flex justify-center items-center flex-col`}>
                <h1 className={`${styles.boldText}`}>Don’t have an account <Link to={"/signup"} className='text-lightGreen cursor-pointer'>Join us today</Link> </h1>
            ...
            <div className="w-full absolute top-[55%] left-0  h-full  ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="#273036" fill-opacity="1" d="M0,32L40,64C80,96,160,160,240,165.3C320,171,400,117,480,96C560,75,640,85,720,96C800,107,880,117,960,106.7C1040,96,1120,64,1200,48C1280,32,1360,32,1400,32L1440,32L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z">
                    </path>
                </svg>
            </div>
