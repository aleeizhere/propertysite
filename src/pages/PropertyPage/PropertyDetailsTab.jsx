...
import { CalendarOutlined, HomeOutlined, InfoOutlined, LineChartOutlined, MoneyCollectOutlined, UserOutlined } from '@ant-design/icons'
...
const homeDetails = [
    ...
    { icon: <MoneyCollectOutlined />, heading: "Average daily rate of 500 ৳", desc: "Monthly rental income will vary based on daily rate and occupancy levels" },
    { icon: <CalendarOutlined />, heading: "80% average occupancy rates", desc: "Daily rates and occupancy levels will vary by season" },
    { icon: <LineChartOutlined />, heading: "14.26% projected annual gross yield", desc: "With an expected net yield of 7.05% and a price per square foot of 2,057 ৳ " },
]
...
const PropertyDetailsTab = () => {
    ...
    return (
        <div className=''>
            <h1 className={`${styles.boldText} text-lightGreen text-2xl mb-6 text-center md:text-left`}>Portfolio {'>'} <span className='font-light text-base'> {"Property Name"} </span> </h1>
            <ImageSlider />
            ...
            <div className="flex flex-col-reverse md:flex-row">
                <div className="md:w-[65%] md:p-5 p-2">
                    ...
                    <div className='pr-5'>
                        ...
                        {/* Property Overview*/}
                        <h1 className={`${styles.boldText} text-lightGreen font-bold md:text-3xl pt-14 pb-5`}>Property Overview</h1>
                        <div className='pb-4'>
                            <p>{text}  {!readMore && '...'}</p>
                        ...
                        {/* Funnding TimeLine */}
                        <h1 className={`${styles.boldText} text-lightGreen font-bold md:text-3xl pt-14 pb-5`}>Funding Timeline</h1>
                        ...
                        <div>
                            <h1 className='flex items-center gap-x-2 font-bold text-lg'> <span className='bg-white flex items-center w-9 h-9 rounded-[100%] p-2'> <InfoOutlined /> </span> Dubai Marina, Dubai United Arab Emirates </h1>
