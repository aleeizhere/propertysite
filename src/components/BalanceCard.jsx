    ...
    return (
        <div className="flex justify-between md:flex-row md:w-[48%] p-2 md:p-5 bg-white rounded-lg">
            <div className=" flex flex-col justify-evenly">
                ...
                <h1 className={`${styles.boldText} text-lightGreen md:text-3xl mt-3`}>{amount}</h1>
            </div>
            {
                btns ?
                    <div className=' flex flex-col justify-evenly gap-y-2 w-40 items-center'>
                        ...
                        <Link className={`md:${styles.boldText} w-full text-center px-5 py-2.5 relative rounded group overflow-hidden font-medium bg-creamWhite text-lightGreen inline-block`}>
