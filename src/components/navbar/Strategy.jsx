    ...
    return (
        <div>
            ...
            <div className={`${styles.boxWidth} m-auto flex justify-evenly flex-col gap-y-4 md:flex-row items-center md:items-start gap-x-7 p-5 md:p-10 mb-10`}>
                <div className=" mt-20 bg-white p-5 h-fit rounded-lg w-full md:w-[30%] text-center md:text-start">
                ...
                <div className="text-xl md:mt-20 bg-white p-5 h-fit rounded-lg w-full md:w-[30%] text-center md:text-start">
