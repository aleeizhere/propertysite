...
import { WalletOutlined, UserOutlined, LogoutOutlined,MoneyCollectOutlined,BankOutlined } from '@ant-design/icons';
    ...
    return (
        <Layout>
            ...
            >
                ...
                <div key={0} style={{ height: '50px', margin: '10px', padding:'10px' }}>
                        <Link to="/landingPage">
                            <img src={logo} alt="" />
                        </Link>
                    </div>
                <Menu theme="light"
                    ...
                    <Menu.Item key={6} >
                        <div className='flex items-center gap-2'>
                            <Avatar icon={<LogoutOutlined />} className={`${styles.flexCenter}`} />
