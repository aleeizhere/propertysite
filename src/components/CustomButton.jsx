...
const CustomButton = ({text, type}) => {
    return (
        <button  type={type} className={`bg-lightGreen p-2 w-full rounded-lg text-white mt-5 relative group focus:ring-4 focus:ring-blue-300 focus:outline-none ${styles.flexCenter} ${styles.boldText}`}>
